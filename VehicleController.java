...
public class VehicleController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(mode.equals("2")){
			...
			//default Add
			response.sendRedirect(request.getContextPath()+"/views/employee/User/addVehicleDetails.jsp");
	...
	protected void insert(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		long RG_userID = (long)session.getAttribute("registeredUserID");
    ...
    protected void edit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/views/employee/User/editVehicleDetails.jsp");
	}
    ...
    protected void show(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		VO_obj.setUserID((long)session.getAttribute("registeredUserID"));

...
@WebServlet("/UploadServletFront")
public class UploadServletFront extends HttpServlet {
	  ...
	  private boolean isMultipart;
	   ...
	   public void doPost(HttpServletRequest request, 
	      ...
	      /*Ends*/
	      response.sendRedirect(request.getContextPath()+"/frontEnd/fileupload/fileUpload.jsp");
	   }catch(Exception ex) {
